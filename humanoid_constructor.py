class Humanoid:
    ...
    def create_humanoid_model(self):
        ...
        <default>
            ...
            <default class="body">
      <geom type="capsule" condim="1" friction=".7" solimp=".9 .99 .003" solref=".015 1" material="body" group="1" contype="4" conaffinity="4"/>
      <default class="thigh">
        <geom size=".06"/>
      </default>
      <default class="shin">
        <geom fromto="0 0 0 0 0 -.36"  size=".049"/>
      </default>
      <default class="foot">
        <geom size=".027"/>
        <default class="foot1">
  ...
  <worldbody>
    <body name="torso" pos="0 0 1.38" childclass="body">
      <freejoint name="root"/>
      ...
      <body name="waist_lower" pos="-.01 0 -.26">
        ...
        <body name="pelvis" pos="0 0 -.165">
          ...
          <body name="thigh_right" pos="0 -.1 -.04">
            ...
            <geom name="thigh_right" fromto="0 0 0 0 .01 -.42" class="thigh"/>
            <body name="shin_right" pos="0 .01 -.48">
              <joint name="knee_right" class="knee"/>
              <geom name="shin_right" class="shin"/>
              <body name="foot_right" pos="0 0 -.48">
                <joint name="ankle_y_right" class="ankle_y"/>
                <joint name="ankle_x_right" class="ankle_x" axis="1 0 .5"/>
                <geom name="foot1_right" class="foot1"/>
                <geom name="foot2_right" class="foot2"/>
                <site name="right_foot_site" pos="0.04 0 0.01"/>
              </body>
            </body>
          </body>
          <body name="thigh_left" pos="0 .1 -.04">
            ...
            <geom name="thigh_left" fromto="0 0 0 0 -.01 -.42" class="thigh"/>
            <body name="shin_left" pos="0 -.01 -.48">
              <joint name="knee_left" class="knee"/>
              <geom name="shin_left" fromto="0 0 0 0 0 -.36" class="shin"/>
              <body name="foot_left" pos="0 0 -.48">
                <joint name="ankle_y_left" class="ankle_y"/>
                <joint name="ankle_x_left" class="ankle_x" axis="-1 0 -.5"/>
                <geom name="foot1_left" class="foot1"/>
                <geom name="foot2_left" class="foot2"/>
                <site name="left_foot_site" pos="0.04 0 0.01"/>
              </body>
            </body>
          </body>
        </body>
  ...
  <equality>
    <joint joint1="abdomen_z" polycoef="0"/>
    <joint joint1="abdomen_y" polycoef="0"/>
    <joint joint1="abdomen_x" polycoef="0"/>
  </equality>
