...
LIFTER_CHECKPOINT="${REPO_ROOT}/checkpoints/posemamba_bicycle_2026_05_24_T_16_14_08/best_epoch.bin"
LIFTER_CONFIG="${REPO_ROOT}/3d_keypoint_detector_training/PoseMamba_train_bicycle.generated.yaml"
